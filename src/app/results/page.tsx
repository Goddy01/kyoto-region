  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Hardware.
            <br />
            <span className="gradient-text">Hard-earned.</span>
          </>
        }
        description="Every placement is a receipt—proof of hours the public never sees."
      />
      ...
      <Section
        ...
        description="Championship moments that defined Kyoto Region."
      >
